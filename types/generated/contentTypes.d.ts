...
export interface ApiRoomRoom extends Schema.CollectionType {
  ...
  attributes: {
    Room_Number: Attribute.String & Attribute.Required;
    classrooms: Attribute.Relation<
      'api::room.room',
      'manyToMany',
      'api::classroom.classroom'
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Code_Student: Attribute.String & Attribute.Required;
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    Name_Subject: Attribute.String & Attribute.Required;
    Code_Subject: Attribute.BigInteger & Attribute.Required;
    Krediet: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
